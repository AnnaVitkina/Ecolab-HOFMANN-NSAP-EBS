...
COLAB_CODE_DIR = Path("/content/Ecolab-HOFMANN-NSAP-EBS")
COLAB_INPUT_DIR = Path(
    "/content/drive/Shareddrives/FA Ops Europe: Rate Maintenance Team "
    "/Documents/AI Adoption RMT/RMT_Ecolab/RMT_ HOFMANN_NSAP_EBS/input"
)
COLAB_PROCESSING_DIR = Path(
    "/content/drive/Shareddrives/FA Ops Europe: Rate Maintenance Team "
    "/Documents/AI Adoption RMT/RMT_Ecolab/RMT_ HOFMANN_NSAP_EBS/processing"
)
COLAB_OUTPUT_DIR = Path(
    "/content/drive/Shareddrives/FA Ops Europe: Rate Maintenance Team "
    "/Documents/AI Adoption RMT/RMT_Ecolab/RMT_ HOFMANN_NSAP_EBS/output"
)
